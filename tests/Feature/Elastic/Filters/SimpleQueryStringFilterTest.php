 ...
 */
class SimpleQueryStringFilterTest extends TestCase
{
    ...
    public function it_can_filter_with_simple_query(): void
    {
        $result = $this
            ...
            ->allowedFilters(SimpleQueryStringFilter::make('name', 'q'))
            ->build()
            ->execute()
            ->models();
    ...
    /** @test */
    public function it_can_filter_with_plus_operator(): void
    {
        $result = $this
            ->createElasticWizardWithFilters(['q' => '+John +Developer'])
            ->allowedFilters(SimpleQueryStringFilter::make('name', 'q'))
            ->build()
            ->execute()
            ->models();
    ...
    /** @test */
    public function it_can_filter_with_pipe_or_operator(): void
    {
        $result = $this
            ->createElasticWizardWithFilters(['q' => 'Designer | Manager'])
            ->allowedFilters(SimpleQueryStringFilter::make('name', 'q'))
            ->build()
            ->execute()
            ->models();
